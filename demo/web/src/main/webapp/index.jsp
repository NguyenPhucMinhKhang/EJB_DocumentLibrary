...
<%@ page import="com.example.ejb.BookBean, com.example.ejb.Book" %>
...
<% 
  ...
  try { 
    ...
    bookBean = (BookBean) ic.lookup("java:module/BookBean");
    } catch (NamingException e) { 
      e.printStackTrace(); 
    } 
    List<Book> books = bookBean != null ? bookBean.getAllBooks() : null;
%>
